...
public class VehicleExistsDialog extends JDialog {
	...
	public VehicleExistsDialog() {
		...
		{
			JLabel lblNewLabel = new JLabel("Vehicle is Already Registered");
			lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 11));
			contentPanel.add(lblNewLabel, "4, 6, center, center");
		}
		
		JLabel lblExists = new JLabel("in SuperRent");
